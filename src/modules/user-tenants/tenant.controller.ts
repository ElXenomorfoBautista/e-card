...
export class TenantController {
    ...
    async updateById(@param.path.number('id') id: number, @requestBody() tenant: Tenant): Promise<void> {
    ...
    async replaceById(@param.path.number('id') id: number, @requestBody() tenant: Tenant): Promise<void> {
