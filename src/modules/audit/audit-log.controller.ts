...
export class AuditLogController {
    ...
    async updateById(@param.path.number('id') id: number, @requestBody() auditLog: AuditLog): Promise<void> {
    ...
    async replaceById(@param.path.number('id') id: number, @requestBody() auditLog: AuditLog): Promise<void> {
